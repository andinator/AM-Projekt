...
public class Tetraeder extends Koerper {
	...
	public Tetraeder() {
		...
		eckpunkt[0] = new Punkt3D(0, 0, Math.sqrt((2 / 3)) - (1 / (2 * (Math.sqrt(6)))));
		eckpunkt[1] = new Punkt3D((-1 / (2 * (Math.sqrt(3)))), -0.5, (-1 / (2 * (Math.sqrt(6)))));
		eckpunkt[2] = new Punkt3D((-1 / (2 * (Math.sqrt(3)))), 0.5, (-1 / (2 * (Math.sqrt(6)))));
		eckpunkt[3] = new Punkt3D((1 / (Math.sqrt(3))), 0, (-1 / (2 * (Math.sqrt(6)))));
